...
Nên đọc theo thứ tự này để nắm nhanh:

1. `SKILL.md` — file entrypoint, rule cốt lõi, danh sách layout, workflow ngắn.
2. `docs/guide/layout-selection.md` — chiến lược chọn layout và tiêu chí chất lượng.
3. `docs/guide/media-and-icons.md` — quy tắc icon, fallback, xử lý hình ảnh/readability.
4. `docs/guide/deck-policy.md` — quy tắc điều hướng deck và canonical reference deck.
5. `docs/layout-json/README.md` — index ví dụ JSON + quy ước đặt tên.
